...
{
    public partial class TiposBook : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    linkBandeira = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TipoTanque", x => x.id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Tanque_Nacionalidade_nacionalidadeId",
                        column: x => x.nacionalidadeId,
                        principalTable: "Nacionalidade",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Tanque_TipoTanque_tipoId",
                        column: x => x.tipoId,
                        principalTable: "TipoTanque",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    PrecoCompra = table.Column<double>(type: "float", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Compra_Tanque_tanqueId",
                        column: x => x.tanqueId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Tanque_nacionalidadeId",
                table: "Tanque",
                column: "nacionalidadeId");

            migrationBuilder.CreateIndex(
                name: "IX_Tanque_tipoId",
                table: "Tanque",
                column: "tipoId");
        }
